...
def test_lab5b3():
    '''Test lab5b3.'''
    # Läs in en bild
    plane_img = cv2.imread("/home/fe1ixj/Desktop/python/tdde23-2024-labbar-14-d1-b-05/lab5/plane.jpg")
...
def test_lab5b4():
    ...
    result = combine_images(gradient_img_list, gradient_condition, generator3, generator4)
